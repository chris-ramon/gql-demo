...
type SubscriptionResolver interface {
	Chats(ctx context.Context) (<-chan []*models.Chat, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Chat.UUID":
		...
		return e.complexity.Chat.UUID(childComplexity), true
	...
	case "Subscription.chats":
		...
		return e.complexity.Subscription.Chats(childComplexity), true
...
func (ec *executionContext) _Chat_UUID(ctx context.Context, field graphql.CollectedField, obj *models.Chat) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Subscription_chats(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Subscription().Chats(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return nil
	...
	return func() graphql.Marshaler {
		res, ok := <-resTmp.(<-chan []*models.Chat)
		if !ok {
			return nil
		}
